package com.jwttoken.jwttoken.security;

import com.jwttoken.jwttoken.domain.Authority;
...
public class CustomUserDetailService implements UserDetailsService {
    ...
    private User createSpringSecurityUser(String username, com.jwttoken.jwttoken.domain.User user) {
        if (!user.isActivated()) {
